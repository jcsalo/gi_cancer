...
H <- c(10.2,6.7,3.9)
M <- c("Low (<5)","Intermediate (5-20)","High (>20)")

# Plot the bar chart 
barplot(H,names.arg=M,xlab="Hospital Volume in Esophahgectomy cases per year",ylab="Risk of Death (Percent)",col="blue",
main="Risk of Mortality after Esophagectomy",border="red")
```
---
...
The Leapfrog Group is a non-profit organization that collects and published safety in healthcare. Their website ranks hospitals for safety and can help you find a high-volume hospital.  A link to their website is available here: [HospitalSafetyGrade.org](https://www.hospitalsafetygrade.org)
