...
`r fa(name = "r-project", fill = "steelblue")`

`r fa(name = "stethoscope", fill = "steelblue")`

`r fa(name = "syringe", fill = "steelblue")`




`r fa(name = "microscope", fill = "steelblue")`


`r fa(name = "x-ray", fill = "steelblue")`

`r fa(name = "radiation", fill = "steelblue")`
...
.Large, .large, .small, .footnotesize, .scriptsize, .tiny:
...
```{r, warning=F,echo=F, message=F, out.width='25%', fig.align='center', fig.cap='RStudio Logo'}
library(showtext)
knitr::include_graphics('../images/Slide06.png')
```

---

<img src="../images/Slide06.png" width="200" height="200" />
