...
This drawing shows a localized tumor. These tumors are T2 and have negative lymph nodes. These tend to be smaller tumors that are less likely to spread to lymph nodes.  In general, because T2 tumors are smaller, they generally don't cause difficulty with eating or weight loss. 
...
This shows a locally-advanced tumors which are either T3 or has signs of spread to lymph nodes. T3 tumors are more likely to spread to lymph nodes than T2 tumors. T3 Tumors are more likely to cause trouble eating or weight loss.  Signs of spread to lymph nodes is generally seen on CT scan or PET scan. In these cases, it is referred to as a "node-positive" cancer.
...
Esophagectomy surgery removes the tumor and the surrounding lymph nodes.  In some cases, however, there is a risk of microscopic disease that can't be seen and can't be removed by surgery alone.
