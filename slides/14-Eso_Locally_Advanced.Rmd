...
This drawing shows a localized tumor. These tend to be smaller tumors that are less likely to spread to lymph nodes

```{r, echo=F, warning =F, message=F, out.width="50%"}
include_graphics("images/t2n0Artboard 3@4x.png")
```


---

This shows a locally-advanced tumors which are either T3 or has tumor spread to lymph nodes. These tumors are more likely to spread to lymph nodes.
...
Esophagectomy removes the tumor and the surrounding lymph nodes.  Unfortunately, once tumor cells have spread to the lymph nodes, there is a risk of microscopic disease that can't be seen and can't be removed by surgery alone.
